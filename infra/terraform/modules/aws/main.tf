...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([{
    name  = "backend"
    image = var.backend_image != "latest" ? var.backend_image : "${aws_ecr_repository.backend.repository_url}:latest"
...
resource "aws_ecs_task_definition" "frontend" {
  ...
  container_definitions = jsonencode([{
    name  = "frontend"
    image = var.frontend_image != "latest" ? var.frontend_image : "${aws_ecr_repository.frontend.repository_url}:latest"
...
resource "aws_ecs_service" "frontend" {
  ...
  depends_on = [
    ...
    aws_iam_role_policy_attachment.ecs_task_execution,
    aws_ecs_service.backend # Ensure backend is up first
  ]
